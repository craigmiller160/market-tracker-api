import { FindWatchlistsForUser, SaveWatchlistsForUser } from '../WatchlistRepository';
import { logAndReturn, logger } from '../../../logger';
import * as TaskTry from '@craigmiller160/ts-functions/TaskTry';
import { WatchlistModel, WatchlistModelInstanceType, watchlistToModel } from '../../../mongo/models/WatchlistModel';
...
export const saveWatchlistsForUser: SaveWatchlistsForUser = (
    ...
    pipe(
        sessionTE,
        TaskEither.chain((session) => TaskTry.tryCatch(() => session.endSession())),
